...
# Compiled tests, with expected outputs

ALL_TESTS = [
    [(test_case, CHARLES_DICKENS_NAME) for test_case in CHARLES_DICKENS_TESTS] +
    [(test_case, FYODOR_DOSTOEVSKY_NAME) for test_case in FYODOR_DOSTOEVSKY_TESTS] +
    [(test_case, LEO_TOLSTOY_NAME) for test_case in LEO_TOLSTOY_TESTS] +
    [(test_case, MARK_TWAIN_NAME) for test_case in MARK_TWAIN_TESTS]
]
