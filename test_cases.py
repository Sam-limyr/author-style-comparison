...
CHARLES_DICKENS_SAME_BOOK_SINGLE_SENTENCE_TESTS = [
    ...
    the two men were heard descending.""",

    """I suppose there was a time once when my father had not
    given matters up; but if ever there was, the time is gone.""",
    ...
    arrival than a stranger might have supposed.""",
...
CHARLES_DICKENS_SAME_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    Norwood.
    The idea of their frightening her, and making her cry, and of
    ...
    He had assured her, he said,
    that it was all nonsense; and he had nothing more to say to her.""",

    """I received this letter by the post on Monday morning, and therefore its
    appointment was for next day.
    Let me confess exactly with what feelings
    ...
    incongruity.
    If I could have kept him away by paying money, I certainly
    would have paid money.
    My greatest reassurance was that he was coming
    to Barnard’s Inn, not to Hammersmith, and consequently would not fall
    in Bentley Drummle’s way.
    I had little objection to his being seen by
    ...
    wrestles with Barnard proved to be.""",
    ...
    his hands.
    Towards this end, indeed, he had purposed to introduce, in
    ...
    It seems to be one of the kind smoothings and
...
FYODOR_DOSTOEVSKY_SAME_BOOK_SINGLE_SENTENCE_TESTS = [
    ...
    We must be patient, and much, much
    can be forgiven.""",

    """We both worried her so that she gave in; but she
    wished us to tell you nothing about it until the day.""",

    """The
    possibility of being loved himself, “a man like me,” as he put it, he
    ranked among ridiculous suppositions.""",

    """He began talking of the news of the town, of the arrival
    ...
    """You treat every one as an equal, and yet every one
    is afraid of you--that's good."""
]
...
FYODOR_DOSTOEVSKY_SAME_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    But I maintain that he is not cunning, not
    practised, and probably this was his first crime!
    The supposition that
    it was a calculated crime and a cunning criminal doesn’t work.
    Suppose
    him to have been inexperienced, and it’s clear that it was only a chance
    that saved him--and chance may do anything.
    Why, he did not foresee
    obstacles, perhaps!
    And how did he set to work?
    He took jewels worth
    ...
    He did not know
    how to rob; he could only murder.
    It was his first crime, I assure you,
    his first crime; he lost his head.
    And he got off more by luck than good
    counsel!”""",
    ...
    which was nearly as good as a dinner.
    The young ladies used to have a
    cup of coffee each before this meal, at ten o’clock, while still in bed.
    This was a favourite and unalterable arrangement with them.
    At half-past
    ...
    For my own
    sake, naturally.
    All the problems of my life would thus be solved;
    I have thought so for a long time.
    I know that once when your sister
    ...
    company of drunkards and wastrels.
    Take no notice of that; I know that
    I have almost ceased to exist.
    God knows what it is dwelling within me
    now--it is not myself.
    I can see it every day in two dreadful eyes which
    are always looking at me, even when not present.
    These eyes are silent
    now, they say nothing; but I know their secret.
    His house is gloomy, and
    ...
    impulsiveness she showed at some critical moments.
    I beg him to consider
    ...
    to say so, absolutely without restraint.
    I beg him to take into
    ...
    focused.
    I must briefly recall, too, the anonymous letter of which she
    had spoken to Praskovya Ivanovna with so much irritation, though I think
    she said nothing of the latter part of it.
    Yet it perhaps contained the
    ...
    might have taken to his bed like Lyamshin.
    ...
    It was a very
    gloomy place at the end of the huge park.
    I went there afterwards on
    purpose to look at it.
    How sinister it must have looked on that chill
    autumn evening!
    It was at the edge of an old wood belonging to the
    Crown.
    Huge ancient pines stood out as vague sombre blurs in the
    darkness.
    It was so dark that they could hardly see each other two paces
    off, but Pyotr Stepanovitch, Liputin, and afterwards Erkel, brought
    lanterns with them.
    At some unrecorded date in the past a rather
    absurd-looking grotto had for some reason been built here of rough
    unhewn stones.
    The table and benches in the grotto had long ago decayed
    and fallen.
    Two hundred paces to the right was the bank of the third
    pond of the park.
    These three ponds stretched one after another for
    a mile from the house to the very end of the park."""
]

FYODOR_DOSTOEVSKY_DIFFERENT_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    """At one time I was unwilling to
    ...
    """I hated the abrupt self-confident tone of his voice, his
    ...
    """He and all of them were laughing; but, seeing me, Zverkov drew
    ...
    his insipid jokes and witticisms.""",
    ...
    """He did his work with the air of doing me the greatest favour,
    ...
    should be forgiven me for what I suffered from him.""",
    ...
    """For there was a time when you and I could see one another
    ...
    """Old lodgers like myself soon grow as attached
    ...
    """At the time I could not understand these reproaches, and it was
    ...
    man of reputation, whereas I--well, I do not exist at all.""",
    ...
    alone--you live but for MY joys and MY sorrows and MY affection!""",

    """Always in my reminiscences I find something which is
    ...
    """Among other things, he undertook the care of an orphaned
    ...
    """Yet I think he would do far better to marry the
...
LEO_TOLSTOY_SAME_BOOK_SINGLE_SENTENCE_TESTS = [
    """If ever at any moment she had been asked what she
    was thinking of, she could have answered truly: of the same thing, of
    her happiness and her unhappiness.""",

    """But she saw him not from
    without, but from within; she saw that here he was not himself; that
    was the only way she could define his condition to herself.""",
    ...
    finding out.... Only do let me into the very... into the chief..."""
]
...
LEO_TOLSTOY_SAME_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    """The doctor, the monthly nurse, and Dolly and her
    mother, and most of all Levin, who could not think of the approaching
    event without terror, began to be impatient and uneasy.
    Kitty was the
    ...
    Often this separate being gave her pain, but at
    ...
    life.
    The only thing that spoiled the charm of this manner of life was
    ...
    were afraid someone would be rude to him, and still more to her.""",
    ...
    Her
    eyes grew dim.
    By the expression of her father’s face, not sad, not
    ...
    “Father!
    Andrew!”—said the ungraceful, awkward princess with such
    ...
    In the center of the stage sat some girls in red
    bodices and white skirts.
    One very fat girl in a white silk dress sat
    apart on a low bench, to the back of which a piece of green cardboard
    was glued.
    They all sang something.
    When they had finished their song
    ...
    her.
    They sang together and everyone in the theater began clapping
    ...
    think of what awaits them, but pass by, winking at the wounded.
    Yet from
    among these men twenty thousand are doomed to die, and they wonder at my
    hat!
    Strange!” thought Pierre, continuing his way to Tatárinova.
    In front of a landowner’s house to the left of the road stood carriages,
    wagons, and crowds of orderlies and sentinels.
...
MARK_TWAIN_SAME_BOOK_SINGLE_SENTENCE_TESTS = [
    ...
    warn't often that we laughed--only a little kind of a low chuckle.""",

    """But she counted and counted till she got that addled she'd start
...
MARK_TWAIN_SAME_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    was the sixth century, or nothing but a dream?
    Dear me, if I could
    only prove it was the latter!
    Here was a glad new hope.
    If the boy
    was right about the date, and this was surely the 20th, it _wasn't_
    the sixth century.
    I reached for the monk's sleeve, in considerable
    excitement, and asked him what day of the month it was.
    Hang him, he said it was the _twenty-first_!
    It made me turn cold
    to hear him.
    I begged him not to make any mistake about it; but
    he was sure; he knew it was the 21st.
    So, that feather-headed
    ...
    So Judge Thatcher and the widow
    ...
    out a declaration of independence, and dares them to come on.
    That was
    _his_ style--he never give anybody a chance.
    He had suspicions of his
    ...
    S'pose people
    left money laying around where he was--what did he do?
    He collared it.
    S'pose he contracted to do a thing, and you paid him, and didn't set
    down there and see that he done it--what did he do?
    He always done the
    other thing.
    S'pose he opened his mouth--what then?
    If he didn't shut it
    up powerful quick he'd lose a lie every time.
    That's the kind of a bug
    ...
    ain't nothing to _that_ old ram, anyway.
    All I say is, kings is kings,
    and you got to make allowances.
    ...
    and enjoyed his impotent struggling and jeered at his threats.
    This
    ...
    trial came on in the court.
    It became the absorbing topic of village
    talk immediately.
    ...
    distress with another sufferer.
...
MARK_TWAIN_DIFFERENT_BOOK_MULTIPLE_PARAGRAPH_TESTS = [
    ...
    ever revealed themselves to man again, they must go.""",
    ...
    """One—two—three; pause; one—two; pause;
    ...
    """When we entered the presence he sat throned,
    ...
    showing its white teeth whenever any slight movement disturbed it.""",
    ...
    """Each of these pretty homes had a garden in front fenced
    ...
    """Tom rained cuffs upon the head and its shield, saying no
    ...
    service in selling her "down the river." """,
    ...
    """In that case he would retain the knife in his possession, not
    ...
    was not a woman, but a man dressed in woman's clothes." """,
]
